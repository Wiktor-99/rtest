This document is a declaration of software quality for the `ros2_test_framework` package, based on the guidelines in [REP-2004](https://www.ros.org/reps/rep-2004.html).
